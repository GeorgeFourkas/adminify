           ...
           fill-rule="nonzero">
            <g transform="translate(1716.000000, 291.000000)">
                <g transform="translate(304.000000, 151.000000)">
                    <polygon
                        class=" opacity-60 group-hover:fill-white {{Str::contains(url()->current(), route('settings')) ? 'fill-white' : 'fill-slate-800'}}"
                    ...
                    <path
                        class="group-hover:fill-white {{Str::contains(url()->current(), route('settings')) ? 'fill-white' : 'fill-slate-800'}}"
