...
<div class="mb-6 hidden h-full transition duration-400 sm:flex-none xl:mb-0" data-role="statistic-card">
    <div class="relative flex h-full min-w-0 flex-col break-words rounded-2xl bg-white bg-clip-border shadow-soft-xl"
...
<div class="mb-6 h-full animate-pulse transition duration-400 sm:flex-none xl:mb-0"
