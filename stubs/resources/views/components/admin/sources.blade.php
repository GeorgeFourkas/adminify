...
<div class="mt-0 w-1/4 max-w-full flex-none py-4 pr-3 pl-0">
    ...
    <div class="flex w-3/4 overflow-visible rounded-lg bg-gray-200 text-xs h-0.75">
        <div class="-ml-px flex w-3/5 flex-col justify-center overflow-hidden whitespace-nowrap rounded-lg bg-slate-700 text-center text-white transition-all duration-600 ease-soft -mt-0.38 h-1.5"
