...
<x-admin.modal-overlay id="create_new_category">
    <div class="relative w-11/12 md:w-10/12 lg:w-3/4 xl:w-1/3 rounded-lg bg-white py-7 px-4">
        ...
        <div class="max-w-11/12 lg:max-w-1/2">
            ...
            <div class="w-full flex items-center justify-between space-x-3">
                <div class="mx-auto my-4 flex w-1/2 flex-col items-start justify-start">
                    <x-input-label
                        class="capitalize"
                ...
                <div class="w-full lg:w-1/2">
                    <x-input-label
                        ...
                        for="input_parent_id"
                    />
                    <x-admin.nested-category-select :categories="$categories" />
                </div>
