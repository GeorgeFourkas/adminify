...
<x-layouts.authentication>
    <div class="w-full lg:w-1/2 flex items-center justify-center h-screen">
        <form method="POST" action="{{ route('login') }}" class="w-2/3 md:mx-5 lg:px-10">
            ...
            @endif
            <div class="w-full">
                <h1 class="text-3xl font-roboto capitalize text-center font-sans font-bold text-transparent gradient-app-theme bg-clip-text">
                    {{ __('adminify.welcome_back') }}
                </h1>
                <p class="text-gray-500 mt-1 block font-light text-center">
