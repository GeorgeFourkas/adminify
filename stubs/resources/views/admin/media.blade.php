<x-layouts.admin>
    ...
    <div class="flex w-full items-end justify-end px-5">
        <button id="upload_new_media"
                class="mt-5 mb-3 cursor-pointer rounded-md px-5 py-2 text-sm font-normal capitalize text-white gradient-app-theme">
            {{ __('adminify.media.action_button') }}
        </button>
    </div>
    <h1 class="text-center text-2xl font-semibold">{{ __('adminify.media.page_title') }}</h1>

    <div class="mt-1 grid w-full grid-cols-8 place-content-center content-center gap-5 px-10">
