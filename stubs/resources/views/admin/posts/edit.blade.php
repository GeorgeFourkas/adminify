        ...
        <form action="{{ route('posts.update', $post) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="w-full lg:-ml-10">
                <div class="flex w-full flex-col-reverse items-start justify-start lg:space-x-8 xl:flex-row">
                    <div
                        class="mx-3 mx-auto mt-10 w-11/12 rounded-lg bg-white px-5 py-8 shadow-soft-2xl lg:w-9/12 lg:px-10">
                                ...
                                <div class="flex flex-col items-start justify-center">
                                    <div class="flex w-full flex-col items-start justify-center">
                                        ...
                                        <x-text-input id="title" type="text" class="mt-1 block w-full"
                                                      name="{{$locale}}[title]"
                                                      :value="old($locale.'.title') ? old($locale.'.title') : $post->translate($locale)?->title"/>
